...
<body id="layout">
<div id="bodyheader">View Timesheet</div>
<br></br>
<div id="bodystyle">
<table id="datatable">
	<tr>
	...
	<tr>
		<td class="datacolumn"><s:if test="user.role=='Student'">
			<s:text name="viewTimesheetScreenVO.studentID" />
		</s:if> <s:if test="user.role=='Staff'">
			<s:text name="viewTimesheetScreenVO.employeeID" />
		</s:if></td>
		<td class="datacolumn"><s:text name="viewTimesheetScreenVO.firstName" /></td>
		<td class="datacolumn"><s:text name="viewTimesheetScreenVO.lastName" /></td>
		<td class="datacolumn"><s:text
			name="viewTimesheetScreenVO.supervisorName" /></td>
		<td class="datacolumn"><s:text
			name="viewTimesheetScreenVO.departmentName" /></td>
	</tr>
</table>
<br></br>
<s:if test="weeks.size > 0">
	...
	<table>
		...
		<tr>
			...
			<s:url id="d_url" action="viewAjaxCall.action" >
...
<s:else>
No timesheets in the system. Please submit timesheets
</s:else>
</body>
</html>
